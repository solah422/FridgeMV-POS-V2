...
const LoginPage: React.FC = () => {
    ...
    useEffect(() => {
        if (currentUser) {
            ...
            else if (currentUser.role === UserRole.CASHIER) navigate('/pos');
        }
            ...
            <main className="flex-1 overflow-y-auto p-8 relative" id="main-content">
                ...
                <div className="mb-8 flex justify-between items-center relative no-print">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold text-white capitalize">{pageName}</h1>
                    </div>
  ...
  return (
    <Routes>
        ...
        <Route element={<ProtectedLayout />}>
            ...
            <Route path="/wholesalers" element={<WholesalerManager />} />
